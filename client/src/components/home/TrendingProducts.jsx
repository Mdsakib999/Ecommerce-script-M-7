...
const TrendingProducts = ({ products }) => {
  ...
  const trendingProducts = products.length > 4 
    ? products.slice(Math.floor(products.length / 2), Math.floor(products.length / 2) + 6)
    : products;
    ...
    <section className="py-20 bg-slate-50 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16 animate-fade-in-up">
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">Trending This Week</h2>
          <p className="text-gray-600 max-w-2xl mx-auto text-lg">
            Discover what everyone is talking about. These pieces are selling out fast.
          </p>
        </div>
